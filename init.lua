...
-- Run :Tutor for basics, :checkhealth for diagnostics
...
vim.g.have_nerd_font = false -- Set true if using Nerd Font
...
require('lazy').setup({
  ...
  -- Autocompletion
  {
    ...
    opts = {
      keymap = {
        preset = 'super-tab', -- Use tab to accept completion
      },
      appearance = {
  ...
  -- Mini modules collection
  {
    ...
    config = function()
      -- Text objects (va) = select around paren, etc.
      require('mini.ai').setup { n_lines = 500 }

      -- Surround operations (saiw) = surround add inner word)
